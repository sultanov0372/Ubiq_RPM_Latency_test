...
namespace Ubiq.XR
{
    ...
    public class DesktopGraber : MonoBehaviour
    {
                ...
                if (Input.GetMouseButtonDown(mouseButton))
                {
                                         ...
                                         Physics.DefaultRaycastLayers))
                    {
                        ...
                        if (grasped != null)
                        {
                            ...
                            // Set isKinematic to true when the object is grabbed
                            var networkedObject = hit.collider.GetComponentInParent<NetworkedGravityChange>();
